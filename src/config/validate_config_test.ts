...
test('[contract] validateConfig: source.deliveries 数组输入不属于当前契约', () => {
  const input = {
    runtimeDir: '/tmp/runtime',
    deliveries: {
      local: {
...
test('[contract] validateConfig: delivery.http 非 canonical 字段应拒绝', () => {
  const input = {
    runtimeDir: '/tmp/runtime',
    deliveries: {
      webhook: {
...
test('[contract] validateConfig: push.http.type 非 canonical 字段应拒绝', () => {
  const input = {
    runtimeDir: '/tmp/runtime',
    deliveries: {
      webhook: {
