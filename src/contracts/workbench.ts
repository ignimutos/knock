...
export type ReaderRunSummary = ConfigWorkbenchReaderRunSummary
export type ReaderFeedSnapshot = ConfigWorkbenchReaderFeedSnapshot
export type ReaderEntrySnapshot = ConfigWorkbenchReaderEntrySnapshot
export type ReaderSourceOverview = ConfigWorkbenchReaderSourceOverview
export type ReaderDeliveryCatalogItem = ConfigWorkbenchReaderDeliveryCatalogItem
export type ReaderOverview = ConfigWorkbenchReaderOverview
