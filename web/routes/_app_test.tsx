...
Deno.test('web app: 应输出主题初始化脚本与默认主题数据属性', () => {
  ...
  assertStringIncludes(html, 'overflow: visible')
})
...
Deno.test('web app: 应输出 details 与 rail 相关样式钩子', () => {
  ...
  assertStringIncludes(html, '.xq-side-column')
  assertStringIncludes(html, 'align-self: stretch')
  assertStringIncludes(html, '.xq-side-rail')
  assertStringIncludes(html, 'align-self: start')
